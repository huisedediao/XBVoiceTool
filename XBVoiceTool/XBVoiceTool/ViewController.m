...
//    NSString *path = [[NSBundle mainBundle] pathForResource:@"output" ofType:@"pcm"];
    NSString *path = [[NSBundle mainBundle] pathForResource:@"xbMedia" ofType:@"caf"];
//    NSString *path = stroePath;
    
    self.palyer = [[XBPCMPlayer alloc] initWithPCMFilePath:path rate:XBAudioRate_16k channels:1 bit:16];
